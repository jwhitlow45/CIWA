"""Create dbo.DailyMain and dbo.HourlyMain

Revision ID: 872b4df20550
Revises: d4b31059af3d
Create Date: 2021-06-30 11:50:52.516036
...
revision = '872b4df20550'
down_revision = 'd4b31059af3d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('DayRelHumMin', sa.Float(), nullable=True),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('HourlyMain')
    op.drop_table('DailyMain')
    # ### end Alembic commands ###
