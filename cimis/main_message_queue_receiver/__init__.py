...
def main(msg: func.ServiceBusMessage):
    ...
    try:
        ...
        action, raw_action = pydantic.parse_raw_as(actions.Action, message)
        logging.info(
        ...
        if action.action_type == actions.ActionType.DATA_CLEAN_DAILY_RAW:
            action, raw_action = pydantic.parse_raw_as(actions.CleanDailyRawDataAction,
                                           message)
            ...
            action, raw_action = pydantic.parse_raw_as(actions.CleanHourlyRawDataAction,
                                           message)
